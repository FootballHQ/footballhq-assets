...
function run(){atomic();historicalGrid()}
...
var z=0;new MutationObserver(function(m){if(!m.some(function(x){return x.addedNodes&&x.addedNodes.length}))return;clearTimeout(z);z=setTimeout(run,25)}).observe(document.documentElement,{childList:true,subtree:true});
setInterval(atomic,500);
})();

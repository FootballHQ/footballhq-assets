/* ============================================================
   ...
   - No global auth polling, no body-wide recovery scans, no 500ms loop
   ============================================================ */
(function(){
'use strict';
...
function releaseAuthShell(){
  ...
  [document.documentElement,document.body].forEach(function(el){
    ...
    try{el.removeAttribute('inert');el.style.removeProperty('pointer-events');el.style.removeProperty('filter');el.style.removeProperty('opacity')}catch(e){}
  });
  var gate=document.getElementById('turfAuthGate');if(gate){try{gate.classList.add('turf-auth-hidden');gate.style.setProperty('display','none','important');gate.style.setProperty('pointer-events','none','important')}catch(e){}}
}
...
window.addEventListener('turf:auth-ready',function(){releaseAuthShell();setTimeout(releaseAuthShell,120)});

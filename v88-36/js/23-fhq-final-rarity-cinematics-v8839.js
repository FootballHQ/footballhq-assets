/* FootballHQ V88.39 — FULL CINEMATIC LOCK + DUPLICATE BRIDGE
...
(function(){
  'use strict';
  if (window.__FHQ_V8839_RARITY_RUNTIME__) return;
  window.__FHQ_V8839_RARITY_RUNTIME__ = true;
  ...
  function revealCard(ctx, delay, rarity){
    setTimeout(()=>{
      ...
      setTimeout(()=>{
        if(ctx.card && ctx.card.isConnected){
          ctx.card.animate([
  ...
  console.log('[FootballHQ] V88.39 full rarity cinematics ready — full-screen hold + duplicate bridge.');
})();

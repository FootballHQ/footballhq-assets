/* ============================================================
   ...
   Loads Home 2.0 v89.18, then cleanup pass v89.19.
   Existing Apps Script script tag does not need to change.
   ============================================================ */
(function(){
'use strict';
if(window.__TURF_V8897_ENTRY_8919__)return;
window.__TURF_V8897_ENTRY_8919__=true;
...
load('https://footballhq.github.io/footballhq-assets/v88-36/js/88-turf-home2-v8918.js?v=8919','8918',function(){
  load('https://footballhq.github.io/footballhq-assets/v88-36/js/89-turf-home2b-v8919.js?v=8919','8919');
});
})();

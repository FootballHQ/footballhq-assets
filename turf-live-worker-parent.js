/* TURF production login bridge v48.
   Worker authenticates. The current Apps Script deployment is the visual/runtime source of truth. */
(function(){
'use strict';
if(window.__TURF_LIVE_WORKER_PARENT_V48__)return;
window.__TURF_LIVE_WORKER_PARENT_V48__=true;

var VERSION='worker-auth-48';
var APP_SRC='https://script.google.com/macros/s/AKfycbwEEff6PG1QLNEcNE5nyr0qcn53iB-pAia8AR5MLpiouZVYeUnUGoEISGL_Z3j1gkhM2A/exec';
